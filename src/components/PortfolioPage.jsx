...
import { FaChartLine, FaRupeeSign, FaCalendarAlt, FaSpinner, FaLeaf, FaArrowUp } from 'react-icons/fa';
          ...
          >
            ...
            <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-2xl p-6">
              <div className="flex items-center justify-between mb-4">
                ...
                <span className="text-2xl font-bold text-white">
                  {portfolio.summary.totalTransactions}
                </span>
              </div>
                ...
                >
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      ...
                      <p className="text-white font-semibold">{holding.totalUnits.toFixed(4)}</p>
                    </div>
                    <div>
                    ...
                    <div>
                      <p className="text-gray-300 text-sm">Avg NAV</p>
                      <p className="text-white font-semibold">₹{holding.avgNavPrice.toFixed(2)}</p>
                    </div>
                    <div>
                      <p className="text-gray-300 text-sm">Transactions</p>
                      <p className="text-white font-semibold">{holding.transactionCount}</p>
                    </div>
                  </div>
                </div>
              ))}
